...
n_words = 200 #Total number of words we can support: 200 sufficient for our task since NLVR vocabulary is small
...
path_train = "geo-train-lm.txt"
path_test = "geo-test-lm.txt"
...
for epoch in range(100):
        ...
        #Generate some text sentences based on LM and supplied starting text:
