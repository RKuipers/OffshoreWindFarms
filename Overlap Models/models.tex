...
N_{y,m,\sigma} / \rho^P_y \geq	M^P_{y, m, \sigma}	&\geq 	\sum_{ip \in I^P} P_{m,ip} \cdot d^P_y / L_y	& \forall \sigma \in S, \forall m \in M, \forall y \in Y 	\\
N_{y,m,\sigma} / \rho^R_{y, ir} \geq M^R_{y, m, \sigma, ir}&\geq 	R_{m,ir,\sigma} \cdot d^R_{y, ir} / L_y 			& \forall \sigma \in S, \forall m \in M, \forall y \in Y, \forall ir \in I^R \\
