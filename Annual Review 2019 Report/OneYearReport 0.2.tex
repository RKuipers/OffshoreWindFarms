...
\item Building a comprehesive multi-level model of the installation projects of OWF sites. 
\item Building a similar model for the maintenance projects.
\item Combining above models into a model spanning the full life cycle.
