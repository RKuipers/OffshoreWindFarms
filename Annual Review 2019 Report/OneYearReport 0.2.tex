...
\item Building a optimisation model and simulation model for the maintenance projects.
\item Combining above models into a multi-level model spanning the full life-cycle, where the optimisation model uses the simulation model.
