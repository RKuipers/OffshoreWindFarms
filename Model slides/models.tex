...
O_p =&  \sum_{a \in A} s_{ai_N\sigma_{it_p}}							& 	\forall p \in P 							\\
...
(2) Makes every task that is finished stay finished 	\\
...
\item $s_{ait}$: Binary variable, 1 if task $i \in I$ for asset $a$ has started at time $t$
\end{itemize}
\end{column}
