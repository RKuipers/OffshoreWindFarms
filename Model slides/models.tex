...
subject to:
\begin{align}
t_{v(i+1)} - t_{vi}				&\geq 	d_{yi} \cdot a_{vi}		& \forall y \in Y, \forall v \in V_y, \forall i \in I 		\\
\sum_{v\in V_y} a_{vi}			&\geq 	\rho_{yi}			& \forall y \in Y, \forall i \in I				\\
t_{vi}			 			&\geq	 	s_i + w_{yi} 			& \forall y \in Y, \forall v \in V_y, \forall i \in I		\\	
t_{vi}			 			&\leq	 	s_i + w_{yi} + m_{yi}	& \forall y \in Y, \forall v \in V_y, \forall i \in I					
\end{align}
