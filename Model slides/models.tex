...
1 \leq& \sum_{t_1 = t_0}^{t_N} [ \sum_{t_2 = t_0}^{t_1} f_{ait_2} \cdot \sum_{t_3 = t_1}^{t_N} s_{ajt_3}]	&	\forall (i, j) \in IP, \forall a \in A	\\
...
0 =& \sum_{t_1 = t_0}^t s_{ajt_1} \cdot \sum_{t_2 = t}^{t_N} f_{ait_2}					&	\begin{aligned} \forall a \in A, \forall t \in T, 	\\
...
N_{rp} \geq& \sum_{a\in A} \sum_{t_1 = t_0}^t \sum_{t_2 = t}^{t_N}  \sum_{i\in \mathcal{I}} (s_{ait_1} \cdot f_{ait_2} \cdot \rho_{ir}) & \forall r \in R, \forall p \in P, \forall t \in T_p \\
o_{at} \leq& \sum_{t_1 = t_0}^{t} f_{ai_Nt_1} \cdot \sum_{i \in M \cup \{i_N\}} \sum_{t_2 = t - \lambda_a}^t f_{ait_2}	&	\forall a \in A, \forall t \in T \\
