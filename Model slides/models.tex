...
(34) Counts up the resources needed in a time period by adding the resources needed by all tasks started, and subtracting the resources needed by all tasks finished	\\
...
(37) Counts how many assets are online \\
(38) Sets a limit on the amount of vessels that can be charatered in a given period
\end{frame}
